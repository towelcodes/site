/* eslint-disable */
// Generated by Wrangler by running `wrangler types --path=./functions/types.d.ts` (hash: 3ec2f84fb5f5c57d4026e15ae84c8a1c)
// Runtime types generated with workerd@1.20260219.0 2023-02-19 
declare namespace Cloudflare {
	interface Env {
		api_cache: KVNamespace;
		KAMAITACHI_KEY: string;
		LISTENBRAINZ_KEY: string;
	}
}
